  ...
  return (
    <div className="main">
      <div className="experienceDiv">
        ...
        <h2>4+ years of professional engineering experience</h2>
      </div>
      ...
      <div className="experienceDiv">
        <h1>Titles Held</h1>
        <h2>February 2022 - February 2026</h2>
        <h2>Software Engineer @ Dynatron Software</h2>
      ...
      <div className="experienceDiv">
        <h2>February 2021 - February 2022</h2>
        <h2>Warehouse Operations Associate @ iHerb</h2>
        <p>Fulfilled logistics behind receiving, processing, and storing inventory.</p>
      </div>

      <div className="experienceDiv">
        <h2>August 2019 - February 2021</h2>
        <h2>Sales Associate @ Walmart</h2>
        <p>Ensured merchandise was stocked and aisles were neat as well as assisting customers as needed.</p>
      </div>

      <div className="experienceDiv">
        <h2>December 2018 - August 2019</h2>
        <h2>Cashier @ Shoprite</h2>
